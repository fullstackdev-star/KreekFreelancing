...
import FJobItem from '../../components/elements/FJobItem';
...
class FJobsCompletedScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FJobsCompletedScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_completed_job_list(params, (json, err) => {
      if (type == 'pull') {
  ...
  _renderItem = ({item}) => {
    return <FJobItem item={item} onPress={this.onJobDetail} />;
  };
...
export default FJobsCompletedScreen;
