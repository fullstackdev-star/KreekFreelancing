...
class FJobsCanceledScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FJobsCanceledScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_canceled_job_list(params, (json, err) => {
      if (type == 'pull') {
...
export default FJobsCanceledScreen;
