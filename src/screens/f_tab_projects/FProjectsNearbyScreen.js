...
class FProjectsNearbyScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FProjectsNearbyScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_nearby_project_list(params, (json, err) => {
      if (type == 'init') {
...
export default FProjectsNearbyScreen;
