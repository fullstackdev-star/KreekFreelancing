...
class FCProjectsOpenScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FCProjectsOpenScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_open_project_list(params, (json, err) => {
      if (type == 'init') {
...
export default FCProjectsOpenScreen;
