...
export default class FSentJobRequestModal extends Component {
  static propTypes = {
  ...
  _renderTitle = () => {
    return (
      <Text
        ...
        <Text style={GStyles.mediumText}>Marian Ramsey</Text> sent you a job
        request.
      </Text>
    );
  };
  ...
  _renderDescription = () => {
    return (
      <Text
        ...
        Interested in working on my project!
      </Text>
    );
  };
  ...
  _renderButton = () => {
    return (
      <TouchableOpacity
        style={[GStyles.centerAlign, {height: 30, marginTop: 45}]}
        onPress={this.onView}>
