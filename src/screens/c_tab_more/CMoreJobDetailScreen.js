...
class CMoreJobDetailScreen extends React.Component {
  constructor(props) {
    super(props);

    console.log('CMoreJobDetailScreen start');
      ...
      <View style={{marginVertical: 40}}>
        <TouchableOpacity onPress={this.onEdit}>
          <View style={GStyles.buttonFill}>
            <Text style={GStyles.textFill}>Edit Post</Text>
          </View>
        </TouchableOpacity>
      </View>
    );
...
export default CMoreJobDetailScreen;
