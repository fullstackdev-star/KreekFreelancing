...
class CMRequestsInterviewCompletedScreen extends React.Component {
  constructor(props) {
    super(props);

    console.log('CMRequestsInterviewCompletedScreen start');
...
export default CMRequestsInterviewCompletedScreen;
