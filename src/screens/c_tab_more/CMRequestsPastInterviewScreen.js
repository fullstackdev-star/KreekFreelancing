...
class CMRequestsPastInterviewScreen extends React.Component {
  constructor(props) {
    super(props);

    console.log('CMRequestsPastInterviewScreen start');
  ...
  onDetail = type => {
    if (type == 'Unconfirmed') {
      this.props.navigation.navigate('c_m_requests_interview_unconfirmed');
    } else if (type == 'Accepted') {
      this.props.navigation.navigate('c_m_requests_interview_accepted');
    } else if (type == 'Completed') {
      this.props.navigation.navigate('c_m_requests_interview_completed');
...
export default CMRequestsPastInterviewScreen;
