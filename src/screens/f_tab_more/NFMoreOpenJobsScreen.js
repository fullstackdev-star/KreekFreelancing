...
class NFMoreOpenJobsScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('NFMoreOpenJobsScreen start');
  ...
  onDetail = () => {
    ...
    navigation.navigate('f_more_job_detail');
  };
...
export default NFMoreOpenJobsScreen;
