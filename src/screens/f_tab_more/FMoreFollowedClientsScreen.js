...
class FMoreFollowedClientsScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FMoreFollowedClientsScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_followed_client_list(params, (json, err) => {
      if (type == 'init') {
...
export default FMoreFollowedClientsScreen;
