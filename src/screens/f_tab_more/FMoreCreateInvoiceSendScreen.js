...
class FMoreCreateInvoiceSendScreen extends React.Component {
  constructor(props) {
    super(props);

    console.log('FMoreCreateInvoiceSendScreen start');
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={this.onPreview}>
          <View style={styles.buttonBlank}>
            <Text style={styles.textBlank}>Preview</Text>
          </View>
        </TouchableOpacity>
...
export default FMoreCreateInvoiceSendScreen;
