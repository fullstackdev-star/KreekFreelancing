...
class CProfessionalsAllScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('CProfessionalsAllScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_all_professional_list(params, (json, err) => {
      if (type == 'init') {
...
export default CProfessionalsAllScreen;
