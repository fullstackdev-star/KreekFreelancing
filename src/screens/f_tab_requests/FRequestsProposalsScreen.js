...
class FRequestsProposalsScreen extends React.Component {
  static contextType = NavigationContext;

  constructor(props) {
    super(props);

    console.log('FRequestsProposalsScreen start');
  ...
  onRefresh = (type) => {
    ...
    RestAPI.get_f_proposal_list(params, (json, err) => {
      if (type == 'init') {
...
export default FRequestsProposalsScreen;
