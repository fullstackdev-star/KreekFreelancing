...
class FRequestsInterviewCompletedScreen extends React.Component {
  constructor(props) {
    super(props);

    console.log('FRequestsInterviewCompletedScreen start');
...
export default FRequestsInterviewCompletedScreen;
