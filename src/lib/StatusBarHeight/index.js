...
const X_12_WIDTH = 390;
const X_12_HEIGHT = 844;

const XSMAX_12_WIDTH = 428;
const XSMAX_12_HEIGHT = 926;

const {height: W_HEIGHT, width: W_WIDTH} = Dimensions.get('window');
console.log('--- crn_dev --- :', Dimensions.get('window'));
...
if (Platform.OS === 'ios' && !Platform.isPad && !Platform.isTVOS) {
  ...
  if (W_WIDTH === X_12_WIDTH && W_HEIGHT === X_12_HEIGHT) {
    isIPhoneWithMonobrow_v = true;
    isIPhoneX_v = true;
  }

  if (W_WIDTH === XSMAX_12_WIDTH && W_HEIGHT === XSMAX_12_HEIGHT) {
    isIPhoneWithMonobrow_v = true;
    isIPhoneXMax_v = true;
  }
}
